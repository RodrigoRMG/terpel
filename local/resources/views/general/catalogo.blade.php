...
<div class="row" style="margin-top: 80px;color:#000!important;">
	<div class="col-md-12">
            ...
            <div class="row profile">
                ...
                <a href="#" class="btncatalogo">Tecnología</a>
                </div>
                <div class="col-md-2" style="margin-right: 40px;">
                <a href="#" class="btncatalogo">Supermercado</a>
                </div>
                <div class="col-md-2 ">
                <a href="#" class="btncatalogo" >Turismo</a>
                </div>
                <div class="col-md-2">
                <a href="#" class="btncatalogo" >Otros</a>
                </div>
            </div>
            ...
            <div class="col-md-6" style="margin-top: 50px;">
            <img src="{{url('public/images/promo/2.jpg')}}" width="100%">
            </div>
                <div class="clearfix"></div>
            <div class="col-md-6" style="margin-top: 50px;">
            <img src="{{url('public/images/promo/3.jpg')}}" width="100%">
            </div>
            <div class="col-md-6" style="margin-top: 50px;" >
            <img src="{{url('public/images/promo/4.jpg')}}" width="100%">
            </div>
